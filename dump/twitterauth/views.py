...
def twitter_return(request):
    ...
    print "HELLO THERE2a", oauthtwitter.__file__
    twitter = OAuthApi(CONSUMER_KEY, CONSUMER_SECRET, token)
    print "HELLO THERE2b", type(twitter)
...
def event_home(request):
    return render_to_response('twitter/event_home.html', {})
