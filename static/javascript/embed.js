...
function fill_widget() {
    ...
    var url = "http://www.ripplefunction.com/camp/widget?campaign=" + campaign_id;
    alert(url);
    //$("#ripple-embed").load(url, function(){alert("HI" + $("#ripple-embed").html())});
    //$('#ripple-embed').html("hello world");
    //$.ajax({url: url,
