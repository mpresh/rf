...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Campaign.page_views_total'
        db.add_column('campaign_campaign', 'page_views_total', self.gf('django.db.models.fields.IntegerField')(default='0'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.page_views_total'
        db.delete_column('campaign_campaign', 'page_views_total')
