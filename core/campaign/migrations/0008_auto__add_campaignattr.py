...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CampaignAttr'
        db.create_table('campaign_campaignattr', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='discount', max_length=100)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=300, null=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attributes', to=orm['campaign.Campaign'])),
        ))
        db.send_create_signal('campaign', ['CampaignAttr'])


    def backwards(self, orm):
        
        # Deleting model 'CampaignAttr'
        db.delete_table('campaign_campaignattr')
