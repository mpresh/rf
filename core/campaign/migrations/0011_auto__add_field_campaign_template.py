...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Campaign.template'
        db.add_column('campaign_campaign', 'template', self.gf('django.db.models.fields.IntegerField')(default='0', null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.template'
        db.delete_column('campaign_campaign', 'template')
