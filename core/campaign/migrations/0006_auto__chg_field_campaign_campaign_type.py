...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.campaign_type'
        db.alter_column('campaign_campaign', 'campaign_type', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Campaign.campaign_type'
        db.alter_column('campaign_campaign', 'campaign_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
