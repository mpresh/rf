...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Campaign.url_redeem'
        db.add_column('campaign_campaign', 'url_redeem', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.url_redeem'
        db.delete_column('campaign_campaign', 'url_redeem')
