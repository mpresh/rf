...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Campaign.twitter_account'
        db.add_column('campaign_campaign', 'twitter_account', self.gf('django.db.models.fields.CharField')(default='RippleFunction', max_length=300, null=True), keep_default=False)

        # Adding field 'Campaign.facebook_fan_page'
        db.add_column('campaign_campaign', 'facebook_fan_page', self.gf('django.db.models.fields.CharField')(default='RippleFunction', max_length=300, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.twitter_account'
        db.delete_column('campaign_campaign', 'twitter_account')

        # Deleting field 'Campaign.facebook_fan_page'
        db.delete_column('campaign_campaign', 'facebook_fan_page')
