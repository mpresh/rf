...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Share.page_views'
        db.add_column('events_share', 'page_views', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Share.page_views'
        db.delete_column('events_share', 'page_views')
