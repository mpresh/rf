...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_share', (
            ...
            ('from_user_twitter', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='made_invites_twitter', null=True, to=orm['tauth.User'])),
            ('from_user_facebook', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='made_invites_facebook', null=True, to=orm['fauth.FBUser'])),
    ...
    models = {
        ...
        'events.share': {
            ...
            'from_user_facebook': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'made_invites_facebook'", 'null': 'True', 'to': "orm['fauth.FBUser']"}),
            'from_user_twitter': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'made_invites_twitter'", 'null': 'True', 'to': "orm['tauth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
