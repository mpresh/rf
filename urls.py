...
urlpatterns += patterns('',
                        ...
                        url(r'ajax/internal_analytics_totalreach_pie$', 
                            'internal_analytics.ajax.analytics_totalreach_pie', 
                            name='internal_analytics_totalreach_pie'),
                        ...
                        url(r'ajax/internal_analytics_totalreach_line$', 
                            'internal_analytics.ajax.analytics_totalreach_line', 
                            name='internal_analytics_totalreach_line'),
