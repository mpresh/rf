...
DATABASE_NAME = 'mpresh'             # Or path to database file if using sqlite3.
DATABASE_USER = 'mpresh'             # Not used with sqlite3.
DATABASE_PASSWORD = '3ab02fe5'         # Not used with sqlite3.
DATABASE_HOST = 'Web130'             # Set to empty string for localhost. Not used with sqlite3.
...
MEDIA_URL = 'http://mpresh.webfactional/site_media'
